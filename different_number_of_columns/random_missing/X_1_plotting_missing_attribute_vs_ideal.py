...
output_plot = 'missing_attributes_vs_ideal'
...
k100j = k100j['Jaccard']
k416j = df[(df['k'] == 416) & (df['percentage'] == percent)]
k416j = k416j['Jaccard']
...
k100r = k100r['RBO']
k416r = df[(df['k'] == 416) & (df['percentage'] == percent)]
k416r = k416r['RBO']
...
k416j = list(mean_confidence_interval(k416j))
k416j.insert(0,416)
k416j.insert(1,'Jaccard')
...
k416r = list(mean_confidence_interval(k416r))
k416r.insert(0,416)
k416r.insert(1,'RBO 0.95')

df = pd.DataFrame([k5j, k10j, k15j,k20j, k40j, k100j,k416j, k5r, k10r, k15r,k20r, k40r, k100r,k416r])
...
ax.set_title("Impact of k on Effectiveness, 95% CI, 50 % A missing")
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing on A to Ideal")
x = [5, 10, 15, 20, 40, 100, 416]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
