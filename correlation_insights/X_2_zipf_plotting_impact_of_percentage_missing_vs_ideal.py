...
output_plot = 'correlation_zipf_all_percentage_missing_vs_ideal'
...
dfj10 = df[(df['k'] == k) & (df['percentage'] == 10) & (df['alpha'] == alpha)]
dfj10 = dfj10['Jaccard']

dfj20 = df[(df['k'] == k) & (df['percentage'] == 20) & (df['alpha'] == alpha)]
dfj20 = dfj20['Jaccard']

dfj30 = df[(df['k'] == k) & (df['percentage'] == 30) & (df['alpha'] == alpha)]
dfj30 = dfj30['Jaccard']

dfj40 = df[(df['k'] == k) & (df['percentage'] == 40) & (df['alpha'] == alpha)]
dfj40 = dfj40['Jaccard']

dfj50 = df[(df['k'] == k) & (df['percentage'] == 50) & (df['alpha'] == alpha)]
dfj50 = dfj50['Jaccard']

dfj60 = df[(df['k'] == k) & (df['percentage'] == 60) & (df['alpha'] == alpha)]
dfj60 = dfj60['Jaccard']

dfj70 = df[(df['k'] == k) & (df['percentage'] == 70) & (df['alpha'] == alpha)]
dfj70 = dfj70['Jaccard']

dfj80 = df[(df['k'] == k) & (df['percentage'] == 80) & (df['alpha'] == alpha)]
dfj80 = dfj80['Jaccard']

dfj90 = df[(df['k'] == k) & (df['percentage'] == 90) & (df['alpha'] == alpha)]
dfj90 = dfj90['Jaccard']
...
dfr10 = df[(df['k'] == k) & (df['percentage'] == 10) & (df['alpha'] == alpha)]
dfr10 = dfr10['RBO']

dfr20 = df[(df['k'] == k) & (df['percentage'] == 20) & (df['alpha'] == alpha)]
dfr20 = dfr20['RBO']

dfr30 = df[(df['k'] == k) & (df['percentage'] == 30) & (df['alpha'] == alpha)]
dfr30 = dfr30['RBO']

dfr40 = df[(df['k'] == k) & (df['percentage'] == 40) & (df['alpha'] == alpha)]
dfr40 = dfr40['RBO']

dfr50 = df[(df['k'] == k) & (df['percentage'] == 50) & (df['alpha'] == alpha)]
dfr50 = dfr50['RBO']

dfr60 = df[(df['k'] == k) & (df['percentage'] == 60) & (df['alpha'] == alpha)]
dfr60 = dfr60['RBO']

dfr70 = df[(df['k'] == k) & (df['percentage'] == 70) & (df['alpha'] == alpha)]
dfr70 = dfr70['RBO']

dfr80 = df[(df['k'] == k) & (df['percentage'] == 80) & (df['alpha'] == alpha)]
dfr80 = dfr80['RBO']

dfr90 = df[(df['k'] == k) & (df['percentage'] == 90) & (df['alpha'] == alpha)]
dfr90 = dfr90['RBO']
...
df = pd.DataFrame([dfj10, dfj20, dfj30, dfj40, dfj50, dfj60, dfj70, dfj80, dfj90,
                   dfr10, dfr20, dfr30, dfr40, dfr50, dfr60, dfr70, dfr80, dfr90])
...
ax.set_title(r'Impact of missing on Effectiveness, $\alpha = 1.4$, k = 10')
ax.set_xlabel("percentage of missing")
ax.set_ylabel("Effectiveness - Zipf missing to Ideal")
