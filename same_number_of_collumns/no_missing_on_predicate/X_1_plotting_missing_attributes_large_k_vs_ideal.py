...
input_file = 'results/large_missing_attributes_vs_ideal.csv'

output_plot = '50_large_k_missing_attributes_vs_ideal'
...
ax.set_title("Impact of k on Effectiveness, 95% CI, 50 % A & M missing")
ax.set_xlabel("k")
