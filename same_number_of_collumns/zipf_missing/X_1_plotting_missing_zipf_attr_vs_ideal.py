...
k15j = k15j['Jaccard']
k20j = df[(df['k'] == 15) & (df['a'] == alpha) & (df['percent'] == percent)]
k20j = k20j['Jaccard']
...
k15r = k15r['RBO']
k20r = df[(df['k'] == 15) & (df['a'] == alpha) & (df['percent'] == percent)]
k20r = k20r['RBO']
...
ax.set_title(r'Impact of k on Effectiveness, Zipf A missing $\alpha = 1.1$')
ax.set_xlabel("k")
