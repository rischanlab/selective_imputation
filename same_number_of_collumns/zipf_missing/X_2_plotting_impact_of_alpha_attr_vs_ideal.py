...
dfj50 = df[(df['k'] == 5) & (df['alpha'] == 1.7) & (df['percent'] == percent)]
dfj50 = dfj50['Jaccard']
...
dfr50 = df[(df['k'] == 5) & (df['alpha'] == 1.7) & (df['percent'] == percent)]
dfr50 = dfr50['RBO']
...
df = pd.DataFrame([dfj00, dfj10, dfj20, dfj30, dfj40, dfj50,
                   dfr00, dfr10, dfr20, dfr30, dfr40, dfr50])
