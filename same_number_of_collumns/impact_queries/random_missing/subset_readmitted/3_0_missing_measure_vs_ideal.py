...
if __name__ == "__main__":
    ...
    for k in k_list:
        ...
        topk = ag.get_topk_aggregate_readmitted(k, file_ideal_topk)
        ...
        for percent in percentage_list:
            for i in range(100):
                ...
                for file_view in glob.glob(file_name):
                    ...
                    missing = ag.get_topk_aggregate_readmitted(k, file_view)
                    ...
                    with open('results/readmitted_missing_measures_vs_ideal.csv', 'a', newline='') as f:
