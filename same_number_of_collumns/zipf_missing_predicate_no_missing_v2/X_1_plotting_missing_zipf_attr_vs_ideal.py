...
k10j = k10j['Jaccard']
k15j = df[(df['k'] == 10) & (df['a'] == alpha) & (df['percent'] == percent)]
k15j = k15j['Jaccard']
...
k100j = k100j['Jaccard']
k256j = df[(df['k'] == 256) & (df['a'] == alpha) & (df['percent'] == percent)]
k256j = k256j['Jaccard']
...
k10r = k10r['RBO']
k15r = df[(df['k'] == 10) & (df['a'] == alpha) & (df['percent'] == percent)]
k15r = k15r['RBO']
...
k100r = k100r['RBO']
k256r = df[(df['k'] == 256) & (df['a'] == alpha) & (df['percent'] == percent)]
k256r = k256r['RBO']
...
df = pd.DataFrame([k5j, k10j, k15j,k20j, k100j,k256j, k5r, k10r, k15r,k20r, k100r,k256r])
...
ax.set_title(r'Impact of k on Effectiveness, Zipf A 50% missing $\alpha = 1.3$')
ax.set_xlabel("k")
ax.set_ylabel("Effectiveness - Missing zipf on A ")
x = [5, 10, 15, 20, 100, 256]#[1.01, 1.5, 2, 2.5, 3, 3.5, 4]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
