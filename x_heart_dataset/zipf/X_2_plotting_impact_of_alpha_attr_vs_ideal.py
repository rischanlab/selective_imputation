...
dfj00 = df[(df['k'] == 5) & (df['alpha'] == 1.1) & (df['percent'] == percent)]
dfj00 = dfj00['Jaccard']

dfj10 = df[(df['k'] == 5) & (df['alpha'] == 1.2) & (df['percent'] == percent)]
dfj10 = dfj10['Jaccard']

dfj20 = df[(df['k'] == 5) & (df['alpha'] == 1.3) & (df['percent'] == percent)]
dfj20 = dfj20['Jaccard']

dfj30 = df[(df['k'] == 5) & (df['alpha'] == 1.4) & (df['percent'] == percent)]
dfj30 = dfj30['Jaccard']

dfj40 = df[(df['k'] == 5) & (df['alpha'] == 1.5) & (df['percent'] == percent)]
dfj40 = dfj40['Jaccard']

dfj50 = df[(df['k'] == 5) & (df['alpha'] == 1.6) & (df['percent'] == percent)]
dfj50 = dfj50['Jaccard']

dfj60 = df[(df['k'] == 5) & (df['alpha'] == 1.7) & (df['percent'] == percent)]
dfj60 = dfj60['Jaccard']
...
dfr00 = df[(df['k'] == 5) & (df['alpha'] == 1.1) & (df['percent'] == percent)]
dfr00 = dfr00['RBO']

dfr10 = df[(df['k'] == 5) & (df['alpha'] == 1.2) & (df['percent'] == percent)]
dfr10 = dfr10['RBO']

dfr20 = df[(df['k'] == 5) & (df['alpha'] == 1.3) & (df['percent'] == percent)]
dfr20 = dfr20['RBO']

dfr30 = df[(df['k'] == 5) & (df['alpha'] == 1.4) & (df['percent'] == percent)]
dfr30 = dfr30['RBO']

dfr40 = df[(df['k'] == 5) & (df['alpha'] == 1.5) & (df['percent'] == percent)]
dfr40 = dfr40['RBO']

dfr50 = df[(df['k'] == 5) & (df['alpha'] == 1.6) & (df['percent'] == percent)]
dfr50 = dfr50['RBO']

dfr60 = df[(df['k'] == 5) & (df['alpha'] == 1.7) & (df['percent'] == percent)]
dfr60 = dfr60['RBO']
...
ax.set_ylabel("Effectiveness - Missing 5% Zipf on A")
